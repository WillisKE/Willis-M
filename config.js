...
global.email ="willisogwel@outlook.com"
...
global.devs = "254702365210" // Developer Contact
global.sudo = process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : "admin";
global.owner= process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : "254702365210";
...
global.save_status_from =  process.env.SAVE_STATUS_FROM  || "254702365210,254786273945";
global.read_status_from =  process.env.READ_STATUS_FROM  ||  "2547702365210,254786273945";
...
module.exports = {
  ...
  caption : process.env.CAPTION || "©²⁰²⁴ ωιℓℓιѕ м∂" , // ```『 ρσωєяє∂ ву ωιℓℓιѕ кє 』```", //*『ωιℓℓιѕ м∂』*\n https://whatsapp.com/channel/0029VaSgyryFi8xYD7QLMB2s"),
 
  author : process.env.PACK_AUTHER|| "ωιℓℓιѕ кє",
  packname: process.env.PACK_NAME || "≛",
  botname : process.env.BOT_NAME  || " ωιℓℓιѕ м∂",
